...
void Phase3::execute()
{
	...
	for(unsigned int iV=0; iV<NV; iV++)
	{
		for(unsigned int iR=0; iR<NR; iR++)
		{
			...
			{
				for(unsigned int iSample=0; iSample<=nSample; iSample++) hSamples.push_back(pT_vd2_1sub[iSample][iV][iR][iC]);
				cal_sts(hSamples,vd2_1sub[iV][iR][iC],"vd2_1sub",iV,iR,iC); hSamples.clear();
				
				for(unsigned int iSample=0; iSample<=nSample; iSample++) hSamples.push_back(pT_vd4_1sub[iSample][iV][iR][iC]);
				cal_sts(hSamples,vd4_1sub[iV][iR][iC],"vd4_1sub",iV,iR,iC); hSamples.clear();
			}
		}
	}
}
...
void Phase3::initialize(unsigned int iBin)
{
	...
	for(unsigned int iSample=0; iSample<=nSample; iSample++)
	{
		...
		for(unsigned int iV=0; iV<NV; iV++)
		{
			for(unsigned int iR=0; iR<NR; iR++)
			{
				readHist_VR(fIn[iSample],rbn_c2_1sub[iSample][iV][iR],"rbn_c2_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_c4_1sub[iSample][iV][iR],"rbn_c4_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_c6_1sub[iSample][iV][iR],"rbn_c6_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_nc4_1sub[iSample][iV][iR],"rbn_nc4_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_nc6_1sub[iSample][iV][iR],"rbn_nc6_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_v2_1sub[iSample][iV][iR],"rbn_v2_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_v4_1sub[iSample][iV][iR],"rbn_v4_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_v6_1sub[iSample][iV][iR],"rbn_v6_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_cr42_1sub[iSample][iV][iR],"rbn_cr42_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_cr64_1sub[iSample][iV][iR],"rbn_cr64_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_sc_1sub[iSample][iV][iR],"rbn_sc_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_nsc_1sub[iSample][iV][iR],"rbn_nsc_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_ac_1sub[iSample][iV][iR],"rbn_ac_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_nac_1sub[iSample][iV][iR],"rbn_nac_1sub",iV,iR);
				readHist_VR(fIn[iSample],rbn_c2_3sub[iSample][iV][iR],"rbn_c2_3sub_Pm1",iV,iR);
				readHist_VR(fIn[iSample],rbn_c4_3sub[iSample][iV][iR],"rbn_c4_3sub_Pm0",iV,iR);
				readHist_VR(fIn[iSample],rbn_v2_3sub[iSample][iV][iR],"rbn_v2_3sub_Pm1",iV,iR);
				readHist_VR(fIn[iSample],rbn_v4_3sub[iSample][iV][iR],"rbn_v4_3sub_Pm0",iV,iR);
				readHist_VR(fIn[iSample],rbn_sc_3sub[iSample][iV][iR],"rbn_sc_3sub_Pm0",iV,iR);
				readHist_VR(fIn[iSample],rbn_nsc_3sub[iSample][iV][iR],"rbn_nsc_3sub_Pm0",iV,iR);
				readHist_VR(fIn[iSample],rbn_ac_3sub[iSample][iV][iR],"rbn_ac_3sub_Pm0",iV,iR);
				readHist_VR(fIn[iSample],rbn_nac_3sub[iSample][iV][iR],"rbn_nac_3sub_Pm0",iV,iR);
			}
		}
		for(unsigned int iV=0; iV<NV; iV++)
		{
			for(unsigned int iR=0; iR<NR; iR++)
			{
				for(unsigned int iC=0; iC<nCent; iC++)
				{
					readHist_VRC(fIn[iSample],pT_vd2_1sub[iSample][iV][iR][iC],"pT_vd2_1sub",iV,iR,iC);
					readHist_VRC(fIn[iSample],pT_vd4_1sub[iSample][iV][iR][iC],"pT_vd4_1sub",iV,iR,iC);
				}
			}
		}
	}
...
void Phase3::finalize(unsigned int iBin)
{
	...
	for(unsigned int iV=0; iV<NV; iV++)
	{
		for(unsigned int iR=0; iR<NR; iR++)
		{
			for(unsigned int iC=0; iC<nCent; iC++)
			{
				vd2_1sub[iV][iR][iC]->Write();
				vd4_1sub[iV][iR][iC]->Write();
			}
		}
	}
	fOut->Close();
...
void Phase3::cal_sts(vector<TH1D*> vIn, TGraphErrors*& gOut, const char* gName, int iV, int iR, int iC)
{
	...
	if(iC<0) sprintf(name,"%s_Har%d_PtRef%d",gName,iV,iR);
	else sprintf(name,"%s_Har%d_PtRef%d_Cent%d",gName,iV,iR,iC);
	gOut->SetName(name);
	...
	for(unsigned int iB=0; iB<NB; iB++)
	{
		double x = 0;
		double y = 0;
		gOut->GetPoint(iB,x,y);
		y = gOut->Eval(x*84./85);
		gOut->SetPoint(iB,x,y);
	}
}
...
void Phase3::readHist_VR(TFile* fIn, TH1D*& hIn, const char* hName, int iV, int iR)
{
	sprintf(name,"%s_Har%d_PtRef%d",hName,iV,iR);
	hIn = (TH1D*)fIn->Get(name);
}

void Phase3::readHist_VRC(TFile* fIn, TH1D*& hIn, const char* hName, int iV, int iR, int iC)
{
