...
Cumu::Cumu(TFile* fIn, unsigned int iRebin)
{
	...
	{
		unsigned int iRtmp = iR;
		if(iR>1) iRtmp = 1;
		sprintf(name,"cnt_1sub_Pt%d",iRtmp);
		cnt_1sub[iR] = (TH1D*)fIn->Get(name);
		for(unsigned int iV=0; iV<NV; iV++)
		{
			readHist_VR(fIn,pc2_1sub_mean[iV][iR],"pc2_1sub_mean",iV,iRtmp);
			readHist_VR(fIn,pc2_1sub_wght[iV][iR],"pc2_1sub_wght",iV,iRtmp);
			readHist_VR(fIn,pc4_1sub_mean[iV][iR],"pc4_1sub_mean",iV,iRtmp);
			readHist_VR(fIn,pc4_1sub_wght[iV][iR],"pc4_1sub_wght",iV,iRtmp);
			readHist_VR(fIn,pc6_1sub_mean[iV][iR],"pc6_1sub_mean",iV,iRtmp);
			readHist_VR(fIn,pc6_1sub_wght[iV][iR],"pc6_1sub_wght",iV,iRtmp);
			readHist_VR(fIn,psc4_1sub_mean[iV][iR],"psc4_1sub_mean",iV,iRtmp);
			readHist_VR(fIn,psc4_1sub_wght[iV][iR],"psc4_1sub_wght",iV,iRtmp);
			readHist_VR(fIn,pac3_1sub_mean[iV][iR],"pac3_1sub_mean",iV,iRtmp);
			readHist_VR(fIn,pac3_1sub_wght[iV][iR],"pac3_1sub_wght",iV,iRtmp);
		}
		for(unsigned int iP=0; iP<NP; iP++)
		{
			...
			for(unsigned int iV=0; iV<NV; iV++)
			{
				readHist_VRP(fIn,pd2_1sub_mean[iV][iR][iP],"pc2_1sub_mean",0,iRtmp,iP); // place holder
				readHist_VRP(fIn,pd2_1sub_wght[iV][iR][iP],"pc2_1sub_wght",0,iRtmp,iP);
				readHist_VRP(fIn,pd4_1sub_mean[iV][iR][iP],"pc4_1sub_mean",0,iRtmp,iP);
				readHist_VRP(fIn,pd4_1sub_wght[iV][iR][iP],"pc4_1sub_wght",0,iRtmp,iP);
			}
		}
		for(unsigned int iA=0; iA<NA; iA++)
		{
			sprintf(name,"cnt_3sub_Pm%d_Pt%d",iA,iRtmp);
			...
			for(unsigned int iV=0; iV<NV; iV++)
			{
				readHist_AVR(fIn,pc2_1_3sub_mean[iA][iV][iR],"pc2_1_3sub_mean",iA,iV,iRtmp);
				readHist_AVR(fIn,pc2_1_3sub_wght[iA][iV][iR],"pc2_1_3sub_wght",iA,iV,iRtmp);
				readHist_AVR(fIn,pc2_2_3sub_mean[iA][iV][iR],"pc2_2_3sub_mean",iA,iV,iRtmp);
				readHist_AVR(fIn,pc2_2_3sub_wght[iA][iV][iR],"pc2_2_3sub_wght",iA,iV,iRtmp);
				readHist_AVR(fIn,pc4_3sub_mean[iA][iV][iR],"pc4_3sub_mean",iA,iV,iRtmp);
				readHist_AVR(fIn,pc4_3sub_wght[iA][iV][iR],"pc4_3sub_wght",iA,iV,iRtmp);
				readHist_AVR(fIn,psc4_3sub_mean[iA][iV][iR],"psc4_3sub_mean",iA,iV,iRtmp);
				readHist_AVR(fIn,psc4_3sub_wght[iA][iV][iR],"psc4_3sub_wght",iA,iV,iRtmp);
				readHist_AVR(fIn,pac3_3sub_mean[iA][iV][iR],"pac4_3sub_mean",iA,iV,iRtmp);
				readHist_AVR(fIn,pac3_3sub_wght[iA][iV][iR],"pac4_3sub_wght",iA,iV,iRtmp);
			}
		}
	}
...
void Cumu::run_sc()
{
	for(unsigned int iR=0; iR<NR; iR++)
	{
		for(unsigned int iV=0; iV<NV; iV++) psc4_1sub_mean[iV][iR]->Divide(psc4_1sub_wght[iV][iR]);

		for(unsigned int iV=0; iV<NV; iV++)
		{
			if(iV==0) cal_sc(pc2_1sub_mean[2][iR],pc2_1sub_mean[3][iR],psc4_1sub_mean[iV+2][iR],raw_sc_1sub[iV][iR]);
			if(iV==1) cal_sc(pc2_1sub_mean[2][iR],pc2_1sub_mean[4][iR],psc4_1sub_mean[iV+2][iR],raw_sc_1sub[iV][iR]);
		...
		for(unsigned int iV=0; iV<NV; iV++)
		{
			for(unsigned int iA=0; iA<NA; iA++) psc4_3sub_mean[iA][iV][iR]->Divide(psc4_3sub_wght[iA][iV][iR]);
		}
		for(unsigned int iV=0; iV<NV; iV++)
		{
			for(unsigned int iA=0; iA<NA; iA++)
			{
				if(iV==0)cal_sc(pc2_1_3sub_mean[iA][2][iR],pc2_2_3sub_mean[iA][3][iR],psc4_3sub_mean[iA][iV+2][iR],raw_sc_3sub[iA][iV][iR]);
				if(iV==1)cal_sc(pc2_1_3sub_mean[iA][2][iR],pc2_2_3sub_mean[iA][4][iR],psc4_3sub_mean[iA][iV+2][iR],raw_sc_3sub[iA][iV][iR]);
	...
	for(unsigned int iR=0; iR<NR; iR++)
	{
		...
		for(unsigned int iV=0; iV<NV; iV++)
		{
			for(unsigned int iA=0; iA<NA; iA++)
			{
				...
				rebin_cumu(raw_ac_3sub[iA][iV][iR],cnt_3sub[iA][iR],rbn_ac_3sub[iA][iV][iR]);
			}
			merge3sub(raw_ac_3sub[0][iV][iR],cnt_3sub[0][iR],raw_ac_3sub[1][iV][iR],cnt_3sub[1][iR],raw_ac_3sub[2][iV][iR],cnt_3sub[2][iR]);
			merge3sub(rbn_ac_3sub[0][iV][iR],rbn_cnt_3sub[0][iR],rbn_ac_3sub[1][iV][iR],rbn_cnt_3sub[1][iR],rbn_ac_3sub[2][iV][iR],rbn_cnt_3sub[2][iR]);
		}
	}
}
...
void Cumu::run_nac()
{
	for(unsigned int iR=0; iR<NR; iR++)
	{
		for(unsigned int iV=0; iV<NV; iV++)
		{
			if(iV==0) cal_nac(raw_c4_3sub[0][1][iR],raw_c2_3sub[1][1][iR],raw_c2_3sub[1][2][iR],raw_ac_1sub[iV][iR],raw_nac_1sub[iV][iR]);
		...
		for(unsigned int iA=0; iA<NA; iA++)
		{
			for(unsigned int iV=0; iV<NV; iV++)
			{
				if(iV==0) cal_nac(raw_c4_3sub[0][1][iR],raw_c2_3sub[1][1][iR],raw_c2_3sub[1][2][iR],raw_ac_3sub[iA][iV][iR],raw_nac_3sub[iA][iV][iR]);
...
void Cumu::cal_d_1sub(TH1D* pd2, TH1D* pc2, TH1D* pd4, TH1D* d2, TH1D* d4)
{
	int NX = d2->GetNbinsX();
	for(int iX=0; iX<NX; iX++)
	{
...
void Cumu::cal_ac(TH1D* pac3, TH1D* ac3)
{
...
void Cumu::cal_v_1sub(TH1D* c2, TH1D* c4, TH1D* c6, TH1D* v2, TH1D* v4, TH1D* v6)
{
	int NX = c2->GetNbinsX();
	for(int iX=0; iX<NX; iX++)
	{
...
void Cumu::cal_v_3sub(TH1D* c2, TH1D* c4, TH1D* v2, TH1D* v4)
{
	int NX = c2->GetNbinsX();
	for(int iX=0; iX<NX; iX++)
	{
...
void Cumu::cal_cr(TH1D* v2, TH1D* v4, TH1D* v6, TH1D* cr42, TH1D* cr64)
{
	int NX = v2->GetNbinsX();
	for(int iX=0; iX<NX; iX++)
	{
...
void Cumu::readHist_VR(TFile* fIn, TH1D*& hIn, const char* hName, int iV, int iR)
{
	sprintf(name,"%s_Har%d_Pt%d",hName,iV,iR);
	hIn = (TH1D*)fIn->Get(name);
}

void Cumu::readHist_VRP(TFile* fIn, TH1D*& hIn, const char* hName, int iV, int iR, int iP)
{
	iP = iR;
...
void Cumu::readHist_AVR(TFile* fIn, TH1D*& hIn, const char* hName, int iA, int iV, int iR)
{
	sprintf(name,"%s_Pm%d_Har%d_Pt%d",hName,iA,iV,iR);
	hIn = (TH1D*)fIn->Get(name);
}

void Cumu::initHist_VR(TH1D*& hIn, const char* hName, int iV, int iR, int iOpt, int iRebin)
{
